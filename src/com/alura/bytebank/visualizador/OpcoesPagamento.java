package com.alura.bytebank.visualizador;

import com.alura.bytebank.model.Pagamento;
import com.alura.bytebank.io.LeitorCSV;
import com.alura.bytebank.servico.ServicoPagamento;
...
public class OpcoesPagamento {
    ...
    private void leituraDeArquivo() {
        System.out.println("Informe o codigo do arquivo que deseja registrar os pagamentos:");
